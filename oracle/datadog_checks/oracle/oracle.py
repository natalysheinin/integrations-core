...
class Oracle(AgentCheck):
    ...
    def __init__(self, name, init_config, instances):
        ...
        self._server, self._user, self._password, self._service, self._jdbc_driver, self._tags = self._get_config(
            self.instance
        )
        ...
        self._query_manager = QueryManager(
            ...
            queries=[queries.ProcessMetrics, queries.SystemMetrics, queries.TableSpaceMetrics],
            tags=self._tags,
        )
    ...
    def _get_config(self, instance):
        ...
        return server, user, password, service, jdbc_driver, tags
